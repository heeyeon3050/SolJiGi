...
"솔직이"는 노년층의 거래 내역을 활용한 개인화된 뇌 활성화 게임 및 외부 활동 유도 플랫폼입니다. 치매 예방 게임 및 진단 검사 결과에 따라 등급을 부여합니다. 등급이 낮을 경우 보호자에게 건강 정보를 제공하고, 보이스피싱이 의심될 경우 알림을 제공하여 노인의 금융 및 일상 안전을 확보합니다. 솔직이로 건강과 금융을 함께 지켜요!
...
- 김희연(팀원 / BE) : 거래 내역 기반의 API 생성, 개인 맞춤형 퀴즈 개발, 1원 인증 기능 개발
